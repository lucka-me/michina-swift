...
public protocol TokenizingModel : SendableMetatype {
...
///
/// This is the main protocol that defines all tokenizer operations, including text processing and
...
/// including normalization, pre-tokenization, and post-processing.
