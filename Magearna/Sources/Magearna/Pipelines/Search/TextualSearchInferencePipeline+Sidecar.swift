//
//  TextualSearchInferencePipeline+Sidecar.swift
//  Magearna
//
...
extension TextualSearchInferencePipeline {
...
fileprivate struct ModelSuiteConfigurations : Decodable {
...
fileprivate struct TokenizerConfigurations : Decodable {
